      ...
      <div style={styles.imageContainer}>
        ...
        <Grid item lg={6} md={6} sm={12}>
          ...
          >
            ...
            <Typography color={"#313c44"} fontSize="25px" fontWeight={600} sx={{color:"#d19c33"}} 
             fontFamily= 'Arial, sans-serif'>
              WAY TO WEALTH'S{" "}
            </Typography>

            <Typography color={"#313c44"} fontSize="17px" fontWeight={400} mb={1}>
            Way To Mutual Funds Webinar{" "}
            </Typography>
           <Typography color={"#313c44"} fontSize="14px" fontWeight={400} mb={2} sx={{display:"flex"}}>
            Live Webinar by <Typography fontSize="14px" fontWeight={600} ml={1}>Kalanithi Pandiyan</Typography>{" "}
            </Typography>
          <BookNow/>
          </Stack>
        </Grid>
